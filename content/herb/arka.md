...
answer: "Arka (Calotropis procera) is a plant used in Ayurveda. INTERNAL USE: only Shodhita (purified) material under physician supervision. Bioavailability: Cardiac glycosides (calotropin, calactin) have good oral absorption with narrow therapeutic index. Shodhana with Dugdha (milk processing) modifies glycoside profile and reduces acute toxicity."
...
productHints: []
words: 322
srcRel: "Ayurveda/Herbs/Single-Herbs/Respiratory-Health/Arka/meta-analysis.md"
---
...
**Dosage Forms:** Churna (root bark powder — after Shodhana), Kshira (processed latex), Taila (medicated oil — external), Lepa (paste — external), Pushpa preparations (flower)
...
**Standardized Extract:** Shodhita root bark extract with total cardenolide content precisely quantified (typical range 0.1-0.5%). Flower extract (non-toxic part) for milder formulations. Latex-based preparations for external pharmaceutical use.

**Shelf Life:** 2 years (Shodhita powder); 3 years (medicated oil); 18 months (Shodhita latex preparation)
