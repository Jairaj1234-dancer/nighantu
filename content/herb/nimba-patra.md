...
group: "Skin-Beauty"
answer: "Nimba Patra (Azadirachta indica) is a plant used in Ayurveda. Nimbolide from leaf has rapid oral absorption (Tmax ~1.5 h) but undergoes significant first-pass metabolism. Leaf polyphenols show pH-dependent absorption with better uptake in alkaline intestinal environment."
botanical: "Azadirachta indica"
family: ""
sanskrit: ""
ayurvedicCategory: ""
whoStatus: ""
aliases: ["Nimba Patra", "NimbaPatra"]
...
productHints: []
words: 319
srcRel: "Ayurveda/Herbs/Single-Herbs/Skin-Beauty/Nimba-Patra/meta-analysis.md"
---
...
**Dosage Forms:** Tablet, Capsule, Churna, Swarasa (fresh juice), Kwatha (decoction), Lepa (paste), Mouthwash, Toothpaste formulation
...
- Aqueous decoction (5-10% w/v)
- Hydroalcoholic extraction (60% ethanol)
- Fresh juice extraction by mechanical pressing
- Spray drying of aqueous extract with maltodextrin
- Ultrasound-assisted extraction for flavonoid-enriched fractions
