...
group: "Skin-Beauty"
answer: "Kamala (Nelumbo nucifera Gaertn.) is a plant used in Ayurveda. Usual dose: 3-6g flower powder twice daily; 500mg-1g extract; 3-5g seed powder; 50-100ml root decoction. Nelumbo nucifera is listed in WHO traditional medicine references and multiple Asian pharmacopoeias including Chinese Pharmacopoeia, Indian Pharmacopoeia, and Japanese Pharmacopoeia."
botanical: "Nelumbo nucifera Gaertn."
family: ""
sanskrit: ""
ayurvedicCategory: ""
whoStatus: "Nelumbo nucifera is listed in WHO traditional medicine references and multiple Asian pharmacopoeias including Chinese Pharmacopoeia, Indian Pharmacopoeia, and Japanese Pharmacopoeia. GRAS food status supports topical safety. CIR safety review completed 2025."
aliases: ["Nelumbo nucifera Gaertn."]
...
|----------|------|
| English | Kamala |
| Latin/Botanical | *Nelumbo nucifera Gaertn.* |
...
- Nelumbo nucifera has food-grade safety status globally; all parts (seeds, rhizomes, leaves, flowers) are consumed as food in Asian cuisines. Cosmetic Ingredient Review (CIR) panel assessed lotus-derived ingredients for safety in 2025
- Nuciferine alkaloid may have sedative effects at high oral doses. Topical lotus extracts are generally well-tolerated with no significant adverse effects reported in clinical studies. Standardization of kaempferol content recommended for cosmetic consistency
...
**Dosage Forms:** Churna (powder - flower, seed, root used differently), Capsule, Tablet, Kashayam (decoction), Taila (seed/flower oil), Lepa (paste), Beeja Churna (seed powder)
...
**Standardized Extract:** Leaf extract standardized to 2% nuciferine (weight management applications); seed extract standardized to 1% neferine (cardiac applications); flower extract standardized to 5% total flavonoids (antioxidant applications); stamen extract per traditional methods

**Shelf Life:** 2 years (flower/leaf/seed powder); 3 years (standardized extract capsule/tablet); 1 year (fresh rhizome); 2 years (dried rhizome)
...
- Hydroalcoholic extraction of leaves/flowers (70:30) for alkaloid and flavonoid fraction
- Aqueous extraction of rhizome (starch-rich)
- Seed protein and starch extraction
- Ethanol extraction of stamens for flavonoid-enriched extract
- CO2 supercritical extraction for alkaloid-enriched fraction
