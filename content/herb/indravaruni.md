...
group: "General-Herbs"
answer: "Indravaruni (Citrullus colocynthis (L.) Schrad.) is a plant used in Ayurveda, from the Cucurbitaceae family. Usual dose: 1-3g fruit powder (use with caution due to purgative action); 250-500mg extract; external oil as directed. Not approved by US FDA for OTC use; recognized in Ayurvedic and Unani pharmacopoeias with mandatory purification (Shodhana) requirements; no WHO monograph endorsing safety."
botanical: "Citrullus colocynthis (L.) Schrad."
family: "Cucurbitaceae"
sanskrit: ""
ayurvedicCategory: ""
whoStatus: "Not approved by US FDA for OTC use; recognized in Ayurvedic and Unani pharmacopoeias with mandatory purification (Shodhana) requirements; no WHO monograph endorsing safety"
aliases: ["Citrullus colocynthis (L.) Schrad."]
...
|----------|------|
| English | Indravaruni |
| Latin/Botanical | *Citrullus colocynthis (L.) Schrad.* |
...
- Antidiabetic use validated through multiple preclinical studies showing alpha-glucosidase inhibition and improved insulin sensitivity
- Purgative use (Virechana) validated but requires strict dose control; traditional Ayurvedic Shodhana (purification) process reduces toxicity
- Anti-inflammatory use confirmed by cucurbitacin-mediated suppression of NF-kB and pro-inflammatory cytokine production
...
**Dosage Forms:** Churna (powder), Capsule, Kashayam (decoction), Taila (oil for external application)
...
**Standardized Extract:** Shodhita (purified) aqueous extract; cucurbitacin B/E standardized extract for research purposes only (not for general supplementation)

**Shelf Life:** 2 years (Shodhita powder); 3 years (purified extract capsule)

**Storage:** Cool, dry place below 25°C. Keep away from children. Clearly labeled as toxic substance requiring professional guidance.

**Marker Compounds:** Cucurbitacin B, Cucurbitacin E, Colocynthin, Colocynthetin, Citrullol

### Extraction Methods

- Aqueous decoction (traditional, milder)
- Hydroalcoholic extraction (50:50) for cucurbitacin-enriched fraction
- Petroleum ether extraction for lipophilic compounds
- Shodhana (detoxification) processing mandatory before internal use
