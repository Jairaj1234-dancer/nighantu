...
answer: "Granthiparni (Leonotis nepetifolia) is a plant used in Ayurveda. Limited modern dosage data - follow classical text guidelines. Bioavailability: Leonotis nepetifolia / Granthiparni (in some traditions identified with other species) - limited modern pharmacokinetic data."
...
**Dosage Forms:** Churna (powder), Kashayam (decoction), Swarasa (fresh juice), Lepa (external paste), Taila (medicated oil)
...
**Standardized Extract:** No widely standardized extract available. Hydroalcoholic extract characterized by HPTLC fingerprint, total phenolic content NLT 2% (as gallic acid equivalent), and total flavonoid content. Develop in-house reference standard from authenticated material.

**Shelf Life:** Fresh juice: use within 6 hours; 1.5 years (powder); 2 years (tablet if formulated); 2 years (Taila)
