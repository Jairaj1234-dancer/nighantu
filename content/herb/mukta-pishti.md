...
group: "Pishtis"
answer: "Mukta Pishti is a bhasma, a mineral or metal preparation reduced to ash by repeated calcination. [Anti-ulcerogenic activity of the marine-pearl derived medicine mukta Pishti in Rat model of pylorus ligation-induced peptic ulcer](https://pubmed.ncbi.nlm.nih.gov/39828143/)."
botanical: ""
family: ""
sanskrit: ""
ayurvedicCategory: ""
whoStatus: ""
aliases: ["Mukta Pishti", "MuktaPishti"]
...
- Anxiety and palpitations (Hridrava, Chittodvega): Clinical practice evidence and mechanistic rationale (calcium-mediated cardiac stabilization, conchiolin peptide neurotransmitter modulation) support the traditional use for heart and mind calming
- Gastric disorders (Amlapitta, Parinamashoola): 2025 preclinical study validated anti-ulcerogenic activity; the calcium carbonate-based acid neutralization mechanism directly supports the traditional antacid use
...
- **Calcium carbonate (CaCO3):** Major component (pearl-derived, >90%)
- **Calcium (Ca):** ~38%
- **Conchiolin protein:** Trace (organic matrix)
- **Strontium (Sr):** Trace
- **Magnesium (Mg):** Trace

**Analytical Methods:** XRD, FTIR, ICP-OES, SEM

## Dosage forms and preparation

**Dosage Forms:** Pishti, Bhasma (Mukta Bhasma also available)

**Standard Dosage:** 60–125 mg twice daily (Pishti); Bhasma: 30–60 mg

**Bioavailability:** Excellent; nacre calcium carbonate (aragonite) with protein matrix — 3× more bioavailable than limestone calcium

**Optimal Timing:** With honey, Malai, or Gulkand; best taken at bedtime for calming effect

**Standardized Extract:** Pearl pishti — cold-processed natural pearl preparation
...
**Vehicle (Anupana):** Honey, Malai (cream of milk), Gulkand, or pomegranate juice

### Stability Notes

Stable indefinitely if kept dry. Aragonite crystal structure maintained in Pishti; converts to calcite in Bhasma (heat-processed)
