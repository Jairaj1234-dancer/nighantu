...
group: "Bhasmas"
answer: "Vanga Bhasma is a bhasma, a mineral or metal preparation reduced to ash by repeated calcination. [TOXICITY STUDIES ON VANGA BHASMA (Part I - with special reference to G. Liver and Pancreas)](https://pubmed.ncbi.nlm.nih.gov/22557446/)."
botanical: ""
family: ""
sanskrit: ""
ayurvedicCategory: ""
whoStatus: ""
aliases: ["Vanga Bhasma", "VangaBhasma"]
...
- RELATIVELY SAFE PROFILE: No toxicity at 8x therapeutic dose for 10 days; GIT, liver, and pancreas remained normal in histopathological examination
- HEAVY METAL INDUSTRY CONCERN: Over 20% of Ayurvedic medications may contain toxic metals; tin-based preparations must be properly purified to ensure conversion to non-toxic oxide form
- LIMITED LONG-TERM DATA: Most safety studies are short-duration (10-90 days). Long-term chronic exposure data for tin Bhasma specifically is limited.
- REPRODUCTIVE USE CAUTION: While traditionally used as Vajikarana, proper dose calibration is essential as excessive tin exposure can have adverse reproductive effects

## What is it made of?

### Mineral/Elemental Profile

- **Tin oxide (SnO2):** Major component
- **Tin (Sn):** >90%
- **Iron (Fe):** Trace
...
**Marker Compounds:** Tin oxide (SnO2), Trace minerals
