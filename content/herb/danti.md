...
group: "General-Herbs"
answer: "Danti (Baliospermum montanum (Willd.) Muell.-Arg.) is a plant used in Ayurveda, from the Euphorbiaceae family. Usual dose: 1-3g powder as purgative (single dose); 500mg-1g for mild laxative effect; use under practitioner supervision due to potent action. Not in WHO monographs; listed in Ayurvedic Pharmacopoeia of India as a Virechana (purgative) drug; classified under Upavisha (semi-toxic) category in some texts requiring mandatory purification."
botanical: "Baliospermum montanum (Willd.) Muell.-Arg."
family: "Euphorbiaceae"
sanskrit: ""
ayurvedicCategory: ""
whoStatus: "Not in WHO monographs; listed in Ayurvedic Pharmacopoeia of India as a Virechana (purgative) drug; classified under Upavisha (semi-toxic) category in some texts requiring mandatory purification"
aliases: ["Baliospermum montanum (Willd.) Muell.-Arg."]
...
|----------|------|
| English | Danti |
| Latin/Botanical | *Baliospermum montanum (Willd.) Muell.-Arg.* |
...
**Dosage Forms:** Churna (powder), Tablet, Kwath (decoction), Bhasma preparation, Capsule
...
**Standardized Extract:** Shodhita (purified) root extract; no standardized commercial extract widely available. Traditional preparation as Churna or Kwath from Shodhita root material. Phorbol ester content must be below safety threshold post-Shodhana.

**Shelf Life:** 1 year (Shodhita powder); 2 years (tablet with moisture barrier packaging)
...
- Traditional Shodhana (purification) processing mandatory before use
- Aqueous decoction after Shodhana
- Hydroalcoholic extraction (60:40) of purified root
- Cold maceration in buttermilk (traditional)
