...
group: "Skin-Beauty"
answer: "Yuthika (Jasminum auriculatum Vahl) is a plant used in Ayurveda. Usual dose: 3-5 g leaf/flower powder twice daily; 50-100 mL decoction twice daily; 10-20 mL fresh leaf juice daily; 2-3 drops essential oil in carrier. Jasminum auriculatum is listed in the Ayurvedic Pharmacopoeia of India."
botanical: "Jasminum auriculatum Vahl"
family: ""
sanskrit: ""
ayurvedicCategory: ""
whoStatus: "Jasminum auriculatum is listed in the Ayurvedic Pharmacopoeia of India. Jasmine species are recognized in WHO traditional medicine references for South-East Asia. Jasmine absolute and concrete are RIFM-assessed for cosmetic safety. No dedicated WHO monograph."
aliases: ["Jasminum auriculatum Vahl"]
...
|----------|------|
| English | Yuthika |
| Latin/Botanical | *Jasminum auriculatum Vahl* |

## Key Phytochemical Constituents

- cis-[Jasmone](/nighantu/glossary/compounds-g-l/#jasmone) (monoterpenoid ketone - characteristic fragrance compound)
- [Linalool](/nighantu/glossary/compounds-l-o/#linalool) (monoterpene alcohol)
...
- [Quercetin](/nighantu/reference/quercetinquercetin/) and rutin [antioxidant](/nighantu/reference/antioxidant/) protection: [Flavonoids](/nighantu/reference/flavonoids/) scavenge free radicals, inhibit lipid peroxidation, and chelate pro-oxidant metal ions, protecting skin cells from oxidative damage and premature aging
- [Antimicrobial](/nighantu/reference/antimicrobial/) wound protection: Leaf extracts inhibit growth of wound-infecting pathogens including S. aureus and E. coli, preventing wound infection and supporting clean wound healing
...
**Bioavailability:** Jasminine and other indole alkaloids have moderate oral bioavailability (~25-40%). Secoiridoids ([oleuropein](/nighantu/glossary/compounds-o-q/#oleuropein)-type) undergo intestinal hydrolysis to hydroxytyrosol with moderate absorption. Jasmine essential oil components (linalool, benzyl acetate, indole) are rapidly absorbed both orally and transdermally. Linalool has good bioavailability (~50%) and CNS penetration ([anxiolytic](/nighantu/reference/anxiolytic/) effect). Flower wax components are poorly absorbed orally but valuable for topical formulations.
...
**Standardized Extract:** Jasmine absolute: linalool >15%, benzyl acetate >20% by GC-MS; leaf extract standardized to >1% total alkaloids (as jasminine by HPLC); >3% total [iridoids](/nighantu/glossary/compounds-g-l/#iridoids)
...
**Marker Compounds:** Jasminine, Jasminidine, Linalool, Benzyl acetate, Indole, Methyl anthranilate, Benzyl benzoate, [Phytol](/nighantu/glossary/compounds-o-q/#phytol), Oleuropein, Jasmone
...
- [Brahmi](/nighantu/herb/brahmi/) (Bacopa monnieri) - calming and cognitive combination
- [Ashwagandha](/nighantu/herb/ashwagandha/) - anxiolytic and [adaptogenic](/nighantu/reference/adaptogenic/) synergy (jasmine aromatherapy + [Ashwagandha](/nighantu/herb/ashwagandha/) oral)
- Rose ([Taruni](/nighantu/herb/taruni/)) - complementary floral aromatherapy
