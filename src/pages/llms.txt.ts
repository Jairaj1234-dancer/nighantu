...
export const GET: APIRoute = async () => {
  const out: string[] = [
    ...
    `- [Chyawanprash Processing Kinetics](${abs('/chyawanprash-processing-kinetics/')}): empirical HPLC and chemical kinetics of ascorbic acid thermal stability, emblicanin tannin buffering, and lipid matrix encapsulation during Avaleha manufacture.`,
    ...
    '',
    `- [Knowledge Graph](${abs('/graph/')}): unified Linked Data JSON-LD graph connecting 1,162 nodes across commercial SKUs, botanical taxonomy, and PubChem chemicals. [JSON-LD](${abs('/knowledge-graph.jsonld')})`,
